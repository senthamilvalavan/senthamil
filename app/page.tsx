  ...
  >
          <div className="flex flex-col items-start">
            ...
            <motion.div variants={springUp} className="flex flex-wrap gap-4">
              ...
              <motion.a whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} href="/Senthamil_Valavan_S_DA.pdf" download="Senthamil_Data_Analyst_Resume.pdf" className="px-6 py-3 border border-white/20 text-white rounded-full font-medium hover:bg-white/10 transition-colors flex items-center gap-2">
