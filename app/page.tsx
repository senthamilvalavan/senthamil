        ...
        >
          <div className="flex flex-col items-start">
            ...
            <motion.div variants={springUp} className="flex flex-wrap gap-4">
              ...
              <motion.a whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} href="/Senthamil_Valavan_S.pdf" download="Senthamil_Data_Analyst_Resume.pdf" className="px-6 py-3 border border-white/20 text-white rounded-full font-medium hover:bg-white/10 transition-colors flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" x2="12" y1="15" y2="3"/></svg>
                DA Resume
              </motion.a>
